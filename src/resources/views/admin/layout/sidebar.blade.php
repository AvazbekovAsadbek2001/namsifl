<div class="deznav">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li>
                <a href="{{ route('admin.employee.index') }}" class="" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
            ...
            <li>
                ...
                <ul aria-expanded="false" class="mm-collapse left">
                    ...
                    <li>
                        <a href="{{ route('admin.message', ['id' => 2]) }}">Stop narko
                            @if(getCountNewMessages(2) > 0)
                                <span class="badge badge-danger badge-xs ms-1">{{ getCountNewMessages(2) }}</span>
                            @endif
                        </a>
                    </li>
                </ul>
