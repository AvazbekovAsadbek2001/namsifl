        ...
        <div class="col-xl-12 col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create Department <img src="{{ asset($lang->flag) }}" width="20px" style="margin-left: 10px"></h4>
                </div>
                <div class="card-body">
                    <div class="basic-form">
                        ...
                        @endif
                        <form action="{{ route('admin.structure.departments.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
